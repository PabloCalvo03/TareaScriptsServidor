...
# URL del endpoint protegido borrar libro pasado por parametro
...
curl -v -X DELETE -H "Authorization: Bearer $token" $PROTECTED_URL -H "Content-Type:application/json"
